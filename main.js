...
console.log("when f key pressed");
}
if(keyPressed =="66"){
new_image("spiderman_body.png");
console.log("when b key pressed");
}
if(keyPressed =="76"){
new_image("hulk_legs.png");
console.log("when l key pressed");
}
if(keyPressed =="82"){
new_image("thor_right_hand.png");
console.log("when r key pressed");
}
if(keyPressed =="72"){
new_image("captain_america_left_hand.png");
console.log("when h key pressed");
}
if(keyPressed =="40"){
down();
